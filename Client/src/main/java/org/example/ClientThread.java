    ...
    public void run() {
        ...
        try {
            ...
            if (response instanceof LeaderboardResponse leaderboardResponse) {
                System.out.println("[" + countryNr + "]" + " Am primit leaderboardResponse: " + leaderboardResponse.getScores());
            }
            ...
            if (response instanceof FinalContentResponse finalContentResponse) {
                System.out.println("[" + countryNr + "]" + " Am primit finalContentResponse: " + finalContentResponse.getParticipantLeaderboardContent());
            }
